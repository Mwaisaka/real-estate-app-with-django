        ...
        {statement && (
          ...
          >
            ...
            <div className="mb-10">
              ...
              <p>
                {/* <strong>Room Number:</strong> {statement.tenant.room_number} |{" "} */}
                <strong>Rent Amount (Kes):</strong>{" "}
                {statement.tenant.rent_amount}
              </p>
              <p>
            ...
            <button
              ...
              className="no-print px-1 bg-blue-400 hover:bg-blue-700 text-white"
            >
              Print Statement
            </button>
            <button
              ...
              style={{ marginTop: "10px", marginLeft: "10px" }}
              className="no-print px-1 bg-green-400 hover:bg-green-700"
            >
              Close Statement
            </button>
          </div>
